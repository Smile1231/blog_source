...
keywords:
  ...
  - Machine Learning
abbrlink: 53fbbba3
date: 2022-07-17 22:44:03
---

`Jupyter`不乏为一个很好的编译工具，搭配上`Anoconda`简直是无敌了
...
for i in a:
	print(i)
```
{% asset_img 2022-07-17-22-46-35.png %}

找到支持中文的字体
{% asset_img 2022-07-17-22-46-44.png %}
...
```
{% asset_img 2022-07-17-22-46-51.png %}
